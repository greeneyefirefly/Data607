...
![Screenshot](C:\Users\Deokinanan\Desktop\2019 -2021 CUNY SPS\SPRING 2019\DATA 607\Week 2\screenshot.jpg)
...
```{r include=FALSE}
db<- dbConnect(MySQL(), user = 'root', password='GUYANA01', dbname = 'shineeranking', host = 'localhost', port=3306)
```
